...
**Last updated:** 2026-04-22 (Google Always-On Memory Agent row verified — 4 `?` cells resolved; Storage upgraded from "Agent-internal" to the specific store; Search cell tightened)
