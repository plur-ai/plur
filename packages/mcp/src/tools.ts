  ...
  return [
    {
      ...
      inputSchema: {
        ...
        properties: {
          ...
          commitment: { type: 'string', enum: ['exploring', 'leaning', 'decided', 'locked', 'draft'], description: 'How firmly the user has committed to this belief (default: leaning). `draft` stages the engram in a review queue.' },
          ...
          engrams: {
            ...
            items: {
              ...
              properties: {
                ...
                commitment: { type: 'string', enum: ['exploring', 'leaning', 'decided', 'locked', 'draft'], description: 'How firmly the user has committed (default: leaning). `draft` stages the engram in a review queue.' },
